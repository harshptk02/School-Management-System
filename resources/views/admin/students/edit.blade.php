                            ...
                            <div class="flex flex-col md:flex-row items-start gap-6">
                                ...
                                <div class="relative group">
                                    <div class="w-32 h-32 rounded-full border-4 border-gray-300 bg-gray-100 flex items-center justify-center overflow-hidden shadow-lg">
                                        <img id="imagePreview" 
                                             src="{{ $student->studentProfile && $student->studentProfile->profile_image ? asset('storage/' . $student->studentProfile->profile_image) : '' }}" 
                                             alt="Profile Preview" 
                                             class="w-full h-full object-cover {{ $student->studentProfile && $student->studentProfile->profile_image ? '' : 'hidden' }}">
                                        <div id="defaultAvatar" class="text-gray-400 text-center {{ $student->studentProfile && $student->studentProfile->profile_image ? 'hidden' : '' }}">
                                    ...
                                    <button type="button" 
                                            id="removeImage" 
                                            class="absolute -top-2 -right-2 w-8 h-8 bg-red-500 text-white rounded-full shadow-lg hover:bg-red-600 transition-colors duration-200 {{ $student->studentProfile && $student->studentProfile->profile_image ? '' : 'hidden' }}">
                        ...
                        <div class="form-grid">
                            <div class="input-group">
                                <input type="text" name="student_id" id="student_id" 
                                       ...
                                       value="{{ $student->studentProfile->student_id ?? '' }}" required>
                            ...
                            <div class="input-group">
                                <input type="text" name="class" id="class" 
                                       class="form-input w-full px-4 py-3 rounded-lg" placeholder=" " 
                                       value="{{ $student->studentProfile->class ?? '' }}" required>
                            ...
                            <div class="input-group">
                                <input type="text" name="section" id="section" 
                                       class="form-input w-full px-4 py-3 rounded-lg" placeholder=" " 
                                       value="{{ $student->studentProfile->section ?? '' }}" required>
                            ...
                            <div class="input-group">
                                <input type="date" name="admission_date" id="admission_date" 
                                       ...
                                       value="{{ $student->studentProfile->admission_date ?? '' }}" required>
