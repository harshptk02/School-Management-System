                ...
                <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <select id="classFilter" class="bg-white/20 backdrop-blur-sm text-black px-8 py-2 rounded-lg border border-white/30 focus:outline-none focus:ring-2 focus:ring-white/50">
                                ...
                                <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-300">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <img src="{{ asset('storage/' . $student->studentProfile->profile_image) }}"
                                                alt="{{ $student->name }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    classFilter.addEventListener('change', function() {
        ...
        tableRows.forEach(row => {
            const classCell = row.querySelector('td:nth-child(4)'); // Adjust the column number based on where the class is displayed
            if (!selectedClass || classCell.textContent.trim().includes(selectedClass)) {
                row.style.display = '';
            } else {
                row.style.display = 'none';
            }
