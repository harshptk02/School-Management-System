    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded shadow-md">
                <form action="{{ route('admin.timetables.store') }}" method="POST" id="timetableForm">
                    @csrf
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="input-group">
                                <input type="text" name="subject" id="subject" class="form-input w-full px-4 py-3 rounded-lg" placeholder=" " required>
                    ...
                    <div class="form-section">
                        ...
                        <div class="time-grid">
                            <div class="input-group">
                                <input type="time" name="start_time" id="start_time" class="form-input w-full px-4 py-3 rounded-lg" required>
                                <label for="start_time" class="floating-label">Start Time</label>
                            </div>

                            <div class="input-group">
                                <input type="time" name="end_time" id="end_time" class="form-input w-full px-4 py-3 rounded-lg" required>
